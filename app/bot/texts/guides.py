class GuideText:
    ...
    DOWNLOAD_WINDOWS: str = """Установка nekoray на Windows скачиваем zip [nekoray](https://github.com/MatsuriDayo/nekoray/releases/download/3.26/nekoray-3.26-2023-12-09-windows64.zip)"""
    VIDEO_WINDOWS: str = 'BAACAgIAAxkBAAIC9GcP7tG9hvT6PTWCOjdbrZlpRAOfAAK8YAACXX6BSLw113YYrOJnNgQ'

    DOWNLOAD_LINUX: str = """Установка nekoray на Linux заходим на github [nekoray](https://github.com/MatsuriDayo/nekoray/releases) и скачивайте файл под свою систему"""

    DOWNLOAD_ANDROID = """Установите v2rayNG на свой телефон [v2rayNG](https://play.google.com/store/apps/details?id=com.v2ray.ang)"""
